# Set "runtests.jl" so ptsf = "tram1_pts.txt" and run four times for each of the EcoTram *.txt files in "ecotram_validation_lines":
# tram1_pts.txt
# tram2_pts.txt
# tram3_pts.txt
# tram4_pts.txt
...
function las2rad_settings(basefolder::String)
    ...
    par_in = Dict(
        ...
        # time step settings
        "t1"  => "01.06.2023 00:01:00", # start time stamp; format "dd.mm.yyyy HH:MM:SS"
        "t2"  => "31.10.2023 23:59:00", # end time stamp
        ...
        # location settings
        "time_zone"   => -6, # relative to UTC (e.g CET = UTC+1) 
    ...
    dat_in = Dict(
        ...
        # swr
        "swrf" => basefolder*"/l2r_input/EcoTram_SWin_met_wetland.txt"
        )
