# Run four times, once for each date (21.06.2023, 30.07.2023, 21.09.2023, 01.11.2023) 
# Use continuous_forest_points.txt in runtests.jl
...
function las2rad_settings(basefolder::String)
    ...
    par_in = Dict(
        ...
        # time step settings (adjust each run)
        "t1"  => "21.06.2023 00:01:00", # start time stamp; format "dd.mm.yyyy HH:MM:SS"
        "t2"  => "21.06.2023 23:59:00", # end time stamp
    ...
    dat_in = Dict(
        # chm
        "dsmf" => basefolder*"/l2r_input/continuous_forest.laz",
        # dtm
        ...
        # dbh
        "dbhf" => basefolder*"/l2r_input/continuous_forest_treeinfo.txt",
        # ltc
        "ltcf" => basefolder*"/l2r_input/continuous_forest_treefilter.laz"
        )
